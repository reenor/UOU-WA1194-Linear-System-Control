...
%% Linear Quadratic Regulator (LQR) control vs Proportional (P) control
...
%% Linear Quadratic Regulator (LQR) Q/R Tuning
...
%% Linear Quadratic Regulator (LQR) Comparison with Reference Tracking
